				...
				<nav id="nav">
					<ul class="sf-menu">
						...
						<?php if($user_role == 'admin' || $user_role == 'petugas'): ?>
							<li><a href="list-atlet.php">Atlet Pencak Silat</a>
								<ul>
									<li><a href="list-atlet.php">Daftar Atlet Pencak Silat</a></li>
									<li><a href="tambah-atlet.php">Tambah Atlet Pencak Silat</a></li>
								</ul>
							</li>
						<?php endif; ?>
