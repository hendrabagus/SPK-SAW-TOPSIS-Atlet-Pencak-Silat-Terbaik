...
?>
	...
	<div class="container clearfix">
		...
		<div class="main-content the-content">
			...
			switch($status):
				case 'sukses-baru':
					$msg = 'Data atlet baru berhasil ditambahkan';
					break;
				case 'sukses-hapus':
					$msg = 'atlet behasil dihapus';
					break;
				case 'sukses-edit':
					$msg = 'atlet behasil diedit';
					break;
			endswitch;
			...
			<h1>Daftar Atlet Pencak Silat</h1>
			...
			<table class="pure-table pure-table-striped">
				<thead>
					<tr class="super-top">
						<th rowspan="2" class="super-top-left">ID Atlet</th>
						<th rowspan="2" class="super-top-left">Nama Atlet</th>
			...
			<?php else: ?>
				<p>Maaf, belum ada data untuk Atlet Pencak Silat.</p>
			<?php endif; ?>
		</div>
